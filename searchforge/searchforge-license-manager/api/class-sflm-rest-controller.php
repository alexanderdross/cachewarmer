...
abstract class SFLM_REST_Controller {

    protected string $namespace = 'sflm/v1';
     ...
     * CORS-Header setzen.
     *
     * Verwendet SFLM_CORS_ALLOWED_ORIGINS (kommaseparierte Liste) statt Wildcard.
    ...
    protected function add_cors_headers( \WP_REST_Response $response ): \WP_REST_Response {
        $allowed = defined( 'SFLM_CORS_ALLOWED_ORIGINS' ) ? SFLM_CORS_ALLOWED_ORIGINS : '';
