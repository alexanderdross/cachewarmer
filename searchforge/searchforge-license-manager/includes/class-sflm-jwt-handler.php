...
class SFLM_JWT_Handler {
    ...
    public function __construct() {
        $this->secret      = defined( 'SFLM_JWT_SECRET' ) ? SFLM_JWT_SECRET : '';
        $this->expiry_days = defined( 'SFLM_JWT_EXPIRY_DAYS' ) ? (int) SFLM_JWT_EXPIRY_DAYS : 30;
    ...
    public function generate( array $payload ): string {
        if ( ! $this->has_secret() ) {
            throw new \RuntimeException(
                'SFLM_JWT_SECRET ist nicht konfiguriert oder zu kurz (mind. 32 Zeichen). '
