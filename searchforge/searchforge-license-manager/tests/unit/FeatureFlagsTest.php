...
class FeatureFlagsTest extends TestCase {
    ...
    private SFLM_Feature_Flags $flags;

    protected function setUp(): void {
        $this->flags = new SFLM_Feature_Flags();
    }
    ...
    public function test_unknown_tier_falls_back_to_free(): void {
        ...
        $free_defaults = SFLM_Feature_Flags::get_tier_defaults( 'free' );
    ...
    public function test_is_development_domain(): void {
        $this->assertTrue( SFLM_Feature_Flags::is_development_domain( 'localhost' ) );
        ...
        $this->assertTrue( SFLM_Feature_Flags::is_development_domain( 'site.test' ) );
        $this->assertTrue( SFLM_Feature_Flags::is_development_domain( '127.0.0.1' ) );
        $this->assertFalse( SFLM_Feature_Flags::is_development_domain( 'example.com' ) );
        $this->assertFalse( SFLM_Feature_Flags::is_development_domain( 'production.de' ) );
    }
}
