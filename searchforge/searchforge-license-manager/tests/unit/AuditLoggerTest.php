...
class AuditLoggerTest extends TestCase {
    ...
    public function test_anonymize_ipv4(): void {
        ...
        $anon = SFLM_Audit_Logger::get_anonymized_ip();
    ...
    public function test_anonymize_ipv4_various(): void {
        ...
        foreach ( $cases as $input => $expected ) {
            ...
            $this->assertEquals( $expected, SFLM_Audit_Logger::get_anonymized_ip(), "Anonymisierung von $input fehlerhaft" );
        }
    }
    ...
    public function test_get_client_ip_without_proxies(): void {
        ...
        $ip = SFLM_Audit_Logger::get_client_ip();
        $this->assertEquals( '203.0.113.50', $ip );
    }

    /**
     * Test: get_client_ip() – X-Forwarded-For wird NICHT vertraut ohne SFLM_TRUSTED_PROXIES.
     */
