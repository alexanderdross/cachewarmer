...
class FeatureFlagsRegressionTest extends TestCase {
    ...
    public function test_free_tier_never_has_premium_features(): void {
        $features = SFLM_Feature_Flags::get_tier_defaults( 'free' );
    ...
    public function test_professional_tier_no_enterprise_features(): void {
        $features = SFLM_Feature_Flags::get_tier_defaults( 'professional' );
    ...
    public function test_enterprise_tier_has_all_features(): void {
        $features = SFLM_Feature_Flags::get_tier_defaults( 'enterprise' );
    ...
    public function test_tier_limits_minimums(): void {
        $free = SFLM_Feature_Flags::get_tier_defaults( 'free' );
        $pro  = SFLM_Feature_Flags::get_tier_defaults( 'professional' );
        $ent  = SFLM_Feature_Flags::get_tier_defaults( 'enterprise' );
    ...
    public function test_all_known_tiers_exist(): void {
        ...
        foreach ( $expected_tiers as $tier ) {
            $features = SFLM_Feature_Flags::get_tier_defaults( $tier );
            $this->assertNotEmpty(
                $features,
