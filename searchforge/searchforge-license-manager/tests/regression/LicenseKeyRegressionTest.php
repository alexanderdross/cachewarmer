...
class LicenseKeyRegressionTest extends TestCase {
    ...
    /**
     * Regression: Key-Format muss SF-{TIER}-{16 Hex} bleiben.
     */
    public function test_key_format_regex_unchanged(): void {
        ...
        foreach ( $valid_keys as $key ) {
            $this->assertTrue(
                SFLM_License_Manager::validate_key_format( $key ),
    ...
    public function test_supported_platforms_unchanged(): void {
        ...
        foreach ( $expected as $platform ) {
            $this->assertTrue(
                SFLM_Installation_Tracker::validate_platform( $platform ),
    ...
    public function test_fingerprint_format_unchanged(): void {
        ...
        $this->assertTrue(
            SFLM_Installation_Tracker::validate_fingerprint( $valid ),
    ...
    public function test_jwt_minimum_secret_length(): void {
        ...
        // SFLM_JWT_SECRET ist im Bootstrap auf > 32 Zeichen gesetzt
