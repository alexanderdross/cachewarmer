                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif ( 'password' === $field['type'] ) : ?>
                                    ...
                                    <button type="button" class="button button-small cwlm-toggle-password" data-target="<?php echo esc_attr( $input_name ); ?>" aria-label="<?php esc_attr_e( 'Passwort anzeigen/verbergen', 'cwlm' ); ?>">
