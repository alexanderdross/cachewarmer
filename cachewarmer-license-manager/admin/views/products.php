                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" style="display:inline;">
                                ...
                                <button type="submit" class="button button-small" title="<?php echo $product->is_active ? esc_attr__( 'Deaktivieren', 'cwlm' ) : esc_attr__( 'Aktivieren', 'cwlm' ); ?>" aria-label="<?php echo $product->is_active ? esc_attr__( 'Mapping deaktivieren', 'cwlm' ) : esc_attr__( 'Mapping aktivieren', 'cwlm' ); ?>">
                            ...
                            <form method="post" style="display:inline;">
                                ...
                                <input type="hidden" name="product_id" value="<?php echo esc_attr( $product->id ); ?>">
                                <button type="submit" class="button button-small cwlm-confirm-action" data-confirm="<?php esc_attr_e( 'Mapping wirklich löschen?', 'cwlm' ); ?>" aria-label="<?php esc_attr_e( 'Mapping löschen', 'cwlm' ); ?>">
