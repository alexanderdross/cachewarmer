                ...
                <?php foreach ( $licenses as $license ) : ?>
                    <tr>
                        <td>
                            ...
                            <button class="button-link cwlm-copy-key" data-key="<?php echo esc_attr( $license->license_key ); ?>" title="<?php esc_attr_e( 'Kopieren', 'cwlm' ); ?>" aria-label="<?php esc_attr_e( 'Lizenzschlüssel kopieren', 'cwlm' ); ?>">
                        ...
                        <td>
                            <?php if ( $license->status !== 'revoked' ) : ?>
                                <form method="post" style="display:inline;">
                                    ...
                                    <button type="submit" class="button button-small" title="<?php esc_attr_e( '+1 Jahr', 'cwlm' ); ?>" aria-label="<?php esc_attr_e( 'Lizenz um 1 Jahr verlängern', 'cwlm' ); ?>">
                                ...
                                <form method="post" style="display:inline;">
                                    ...
                                    <button type="submit" class="button button-small cwlm-confirm-action" data-confirm="<?php esc_attr_e( 'Lizenz wirklich sperren?', 'cwlm' ); ?>" title="<?php esc_attr_e( 'Sperren', 'cwlm' ); ?>" aria-label="<?php esc_attr_e( 'Lizenz sperren', 'cwlm' ); ?>">
